...
- Mesh agnostic representations (NJF)
...
$$
C = \underset{C}{\text{argmin}} ||Ca - b||² = \underset{C}{\text{argmin}} \text{ data_loss(C)}
$$
...
## Score Distillation sampling {.medium-small}
### Details
...
![DinoV2 features](images/pitch_out_of_distribution-36acdf0d.png){width=350}
...
![&nbsp; ](images/patchalign.png){.r-stretch}
...
![&nbsp; ](images/results_patch.png){.r-stretch}
